...
plt.plot(df['time'], df['twsa'], marker='o', markersize=4, linestyle='-', color='b', linewidth=2, label='Orijinal TWSA Gözlemi')
...
# Görsel ayarlar
plt.title('Fırat-Dicle Havzası TWSA Değişimi (STL Doldurma Modeli)', fontsize=16, fontweight='bold')
...
# Kaydet
kayit_adi = 'Firat_Dicle_Havzasi_twsa_stl_grafik.png'
