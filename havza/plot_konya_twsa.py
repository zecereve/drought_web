...
plt.plot(df['time'], df['twsa'], marker='', linestyle='-', color='g', linewidth=2, label='TWSA (Karasal Su Depolama)')

# Görsel düzenlemeler
plt.title('Konya Kapalı Havzası TWSA Değişimi (2002 - 2026)', fontsize=16, fontweight='bold')
...
kayit_adi = 'Konya_Kapali_Havzasi_twsa_grafik.png'
